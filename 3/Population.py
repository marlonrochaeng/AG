...
class Population:
  ...
  def get_fitness(self, i, type_of):
    if type_of == 1:
      ...
      #apple - eat + that
      return abs((i[1]*10000 + i[4]*1000 + i[4]*100 + i[5]*10 +i[6]) - (i[0]*100 + i[1]*10 + i[2] +i[2]*1000 + i[3]*100 + i[1]*10 +i[2]))
    elif type_of == 3:
      #cross roads danger c0 r1 o2 s3 a4 d5 n6 g7 e8
      #danger - cross roads
      return abs((i[5]*100000 + i[4]*10000 + i[6]*1000 + i[7]*100 + i[8]*10 + i[1]) - (i[0]*10000 + i[1]*1000 + i[2]*100 + i[3]*10 +i[3] + i[1]*10000 + i[2]*1000 + i[4]*100 + i[5]*10 +i[3]))
    elif type_of == 4:
      #coca cola oasis coalsi c0 o1 a2 l3 s4 i5
      #oasis - coca + cola
      return abs((i[1]*10000 + i[2]*1000 +i[4]*100 + i[5]*10 + i[4]) - (i[0]*1000 + i[1] * 100 + i[0]*10 + i[2] + i[0]*1000 + i[1] * 100 + i[3]*10 + i[2]))
    elif type_of == 5:
      #donald gerald robert d0 o1 n2 a3 l4 g5 e6 r7 b8 t9
      #012340 567340 718679

      return abs((i[7]*100000 + i[1]*10000 + i[8]*1000 + i[6]*100 + i[7]*10 + i[9]) - (i[5]*100000 + i[6]*10000 + i[7]*1000 + i[3]*100 + i[4]*10 + i[0] +  i[0]*100000 + i[1]*10000 + i[2]*1000 + i[3]*100 + i[4]*10 + i[0]))
  ...
  def create_first_gen(self):
    ...
    for i in range(100):
      ...
      self.pop.append((individuo,self.get_fitness(individuo,5)))
  ...
  def single_crossover(self, pos):
    ...
    child1 = temp1, self.get_fitness(temp1,5)
    child2 = temp2, self.get_fitness(temp1,5)
  ...
  def multi_crossover(self, pos):
    ...
    return [(child1[0], self.get_fitness(child1[0],5)) , (child2[0], self.get_fitness(child2[0],5))]
  ...
  def complete_population(self):
    for i in range(30):
      ...
      self.pop.append((individual,self.get_fitness(individual,5)))
  ...
  def cycle_cross(self, p1, p2):
    ...
    return (child1, self.get_fitness(child1,5)), (child2, self.get_fitness(child2,5))
  ...
  def cx_modified(self):
    ...
    return [(child_1, self.get_fitness(child_1,5)), (child_2, self.get_fitness(child_2,5))]
  ...
  def pmx(self):
    ...
    return (ind1, self.get_fitness(ind1,5)), (ind2, self.get_fitness(ind2,5))
  ...
  def cx_cross_pmx(self):
    ...
    return [(filho1, self.get_fitness(filho1,5)), (filho2, self.get_fitness(filho2,5))]
  ...
  def mutation(self):
    for i in range(len(self.pop)):
      if random.uniform(0,100) <= 20:
        ...
        self.pop[i][0][p2] = aux
        self.pop[i] = self.pop[i][0], self.get_fitness(self.pop[i][0],5)
